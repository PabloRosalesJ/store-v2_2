  ...
  <div>
    <div class="card">
      <div class="card-header p-2 bg-danger">
        <h4 class="text-center text-white">Realizar creédito</h4>
      </div>
      <div class="card-body">
        <div class="row">
          <div class="col-3">
              ...
              <div class="col-6">
                ...
                <div class="form-gropu" v-if="product">
                  ...
                  <div class="row align-items-center">
                    ...
                    <div class="col-4">Total: ${{ ProductSelectTotal }}</div>
                    <div class="col-4">
                      <div class="form-group">
                          <label>take? </label>
                          <div class="switch switch-info d-inline m-r-10">
                              <input type="checkbox" id="switch-p-1" v-model="take">
                ...
                <table class="table table-sm table-hover">
                  ...
                  <tbody v-if="cart.length >= 1">
                    <tr v-for="(c, index) in cart" :key="c.id">
                      ...
                      <td>{{c.take === true ? 'Se tomará de almacén': 'NO se tomará de almacén'}}</td>
                      <td>
