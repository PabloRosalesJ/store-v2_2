              ...
              <div class="change-profile text-center">
                ...
                <div class="dropdown w-auto d-inline-block">
                  ...
                  >
                    ...
                    <div v-if="user.status" class="certificated-badge">
                      <i
                        class="fas fa-cart-plus text-c-blue bg-icon"
                        title="OK"
                      ></i>
                    </div>
                    <div v-if="!user.status" class="certificated-badge">
                      <i
                        class="fas fa-cart-plus text-c-yellow bg-icon"
                        title="Precaución. 
Ha este cliente no se le puede vender a crédito."
              ...
              <h5 class="mb-1" v-text="user.username"></h5>
              <p class="mb-2 text-muted">
                {{ user.person.name }} {{ user.person.l_name }}
                {{ user.person.s_name }}
              </p>
              <p class="mb-2 text-muted">
                <button
                ...
                <div class="col-md-6">
                  <div class="media">
                    ...
                    <div class="media-body">
                      <p class="mb-0 text-muted">{{ user.person.address }}</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              >
                <li class="nav-item" role="presentation">
                  <a
                    ...
                    aria-selected="true"
                    ><i class="feather icon-shopping-cart mr-2"></i>Ventas</a
                  >
                </li>
                <li class="nav-item" role="presentation">
                  <a
...
<script>
import ShoppingComponent from "../../components/Users/Users/ShopsComponent";
import CreditComponent from "../../components/Users/Users/CreditComponent";
import PaysComponent from "../../components/Users/Users/PaysComponent";
...
export default {
  ...
  methods: {
    getClient() {
      axios
        .get(`${this.BASE_URL}/api/user/${this.$route.params.id}/show`)
        .then((result) => {
